...
if (isset($_POST['submit'])) {
    ...
    mysqli_query($conn, "UPDATE user_form SET name='$new_name' 
    ...
    if(!empty($user_old_pass) || !empty($new_pass) || !empty($confirm_new_pass)){
        if($old_pass != $user_old_pass){
            ...
            mysqli_query($conn, "UPDATE user_form SET password='$new_pass' 
    ...
    if(!empty($image)){
        if ($image_size > 2000000) {
            ...
            $image_query= mysqli_query($conn, "UPDATE user_form SET image='$image' 
                            WHERE id='$user_id'") or die('query failed');
        ...
        <div class="update-profile">
            <?php
                ...
                if($fetch['image'] == ''){
                    ...
                    echo "<img src='uploaded_imgs/".$fetch['image']."'>";
                }
